...
class ListCell: TableTemplate {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        let deLabel = CLabel(Style().text("详情").textColor(UIColor.black).font(UIFont.systemFont(ofSize: 15)))
    ...
    override func setModel(_ amodel: Cat) {
        ...
        if amodel is ListModel{
            let a = amodel as! ListModel
            //            ob.v_text = a.name
